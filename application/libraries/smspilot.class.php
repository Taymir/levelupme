<?php
/* SMS Pilot.Class API/PHP v1.8.3
 * SEE: http://www.smspilot.ru/apikey.php
 ...
 Example 2 (replace sender + send):
  ...
  Example 4: (т.к. 79.... запрещён в отправителе, то используем, 89..., указываем также что наша кодировка Windows-1251, проверяем автозамену 89.. получателя)
  	include('smsplot.class.php');
	$sms = new SMSPilot('XXXXXXXXXXXXYYYYYYYYYYYYZZZZZZZZXXXXXXXXXXXXYYYYYYYYYYYYZZZZZZZZ','WINDOWS-1251');
...
//	public $use_ssl = false; //removed in 1.8.3, see $sms->api property
	...
	public function send( $to = false, $text = false, $from = false ) {
