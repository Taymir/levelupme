...
<tr>
    ...
    <td><?php echo anchor(array('admin_schools', 'remove_class', $class->id), "[X]", array('class' => "editbutton", 'onclick' => "return confirm('Вы уверены, что хотите удалить эту страницу?')")); ?>&nbsp;<?php echo anchor(array('admin_schools', 'edit_class', $class->id), "[O]", array('class' => "editbutton")); ?></td>
</tr>
<?php endforeach; ?>
<?php endforeach; ?>
</tbody>
